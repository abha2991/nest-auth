...
const Card2 = () => {
  ...
  const groom=[ "GroomName","StaticData3",
    "GroomFatherName","GroomMotherName",
   "StaticData4",
    "GroomGrandFatherName","StaticData5",
    "GroomGrandMotherName","Grrom",
    "StaticData6","StaticData7",
    "Anamika Agrawal", "Daughter of",
    "Mr. Shubham agrawal", "Mrs. Monika Agrawal",
    "With", "Sandeep Rawat",
    "Son of", "Mr. Shubham agrawal",
    "Mrs. Monika Agrawal", "TOGETHER WITH THEIR",
    "FAMILY AND FRIENDS"]

  const bride=["BrideName","StaticData1","BrideFatherName","StaticData2","BrideMotherName","Anamika","Weds","Sandeep","WEDDING INVITAION","17TH July 2022"
     ]
...
//   }
  ...
  const PostData = async (e) => {
    ...
    Details = [{bridename,staticdata1, groomName,staticdata2, date},
      {groomname,staticdata3, groomfather, groommother,staticdata4, brideName,staticdata5,brideFathername,grrom,staticdata6,staticdata7}, {staticdata8,text,staticdata9,venue,_date}]
                        ...
                        <div className="card-box">
                            <div style={{
                              background: `url(${card1}) no-repeat center/cover`,textAlign: "center", width: "100%", fontFamily: 'Lora', color: "#7132A1", height: "100%", padding: "100px 0"
                                ...
                                <h2  data-bs-toggle="modal" data-bs-target="#id3">{brideData.BrideFatherName}</h2>
                                <p className="mb-0 mt-3" style={{ fontSize: "small" }}><strong>{brideData.StaticData2}</strong></p>
                                <p data-bs-toggle="modal" data-bs-target="#id5" style={{ fontSize: "small" }}>{brideData.BrideMotherName}</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-4">
                        <div className="card-box">
                            <div style={{
                              ...
                              textAlign: "center", width: "100%", fontFamily: 'Lora', color: "#7132A1", height: "100%", padding: "100px 0"
                                ...
                                <h4 data-bs-toggle="modal" data-bs-target="#id6" style={{ paddingTop: "75px" }}>{groomData.GroomName}</h4>
                                <p  style={{ color: "#CC8935", fontSize: "10px", marginBottom: "0" }}>{groomData.StaticData3} <br /><span  data-bs-toggle="modal" data-bs-target="#id8">{groomData.GroomFatherName}</span> & <span  data-bs-toggle="modal" data-bs-target="#id9">{groomData.GroomMotherName}</span></p>
                                <p style={{ color: "#CC8935", marginTop: "10px", marginBottom: "5px" }}>{groomData.StaticData4}</p>
                                <h4 data-bs-toggle="modal" data-bs-target="#id11" className="mb-0">{groomData.GroomGrandFatherName}</h4>
                                <p  style={{ color: "#CC8935", fontSize: "10px", marginBottom: "0" }}>{groomData.StaticData5}<br /><span  data-bs-toggle="modal" data-bs-target="#id13">{groomData.GroomGrandMotherName}</span> & <span  data-bs-toggle="modal" data-bs-target="#id14">{groomData.Grrom}</span></p>
                                <p className="mb-0 mt-3" style={{ color: "#CC8935", fontSize: "small" }}>{groomData.StaticData6}</p>
                        ...
                        <div className="card-box">
                            <div style={{
                              ...
                              textAlign: "center", width: "100%", fontFamily: 'Lora', color: "#7132A1", height: "100%", padding: "100px 0"
                                ...
                                <p data-bs-toggle="modal" data-bs-target="#id18" style={{ color: "#CC8935", fontSize: "12px" }}>{rsvpData.ProgramName}</p>
                                <h4>{rsvpData.StaticData9}</h4>
                                <p data-bs-toggle="modal" data-bs-target="#id21" style={{ color: "#CC8935", fontSize: "12px" }}>{rsvpData.Venue}</p>
                                <p data-bs-toggle="modal" data-bs-target="#id20" className="mb-0 mt-3" style={{ color: "#CC8935", fontSize: "small" }}>{rsvpData._Date}</p>
                            </div>
                        </div>
                    </div>
                </div>
          ...
          dummyData1?.map((val,index)=>{
            return(
                <Modal
                    ...
                    // reset={()=> {
                    //
                    //   setGroomData({...groomData,GroomName: "Anamika Agrawal", StaticData3:"Daughter of",
                    //     GroomFatherName: "Mr. Shubham agrawal",
                    //     GroomMotherName: "Mrs. Monika Agrawal",
                    //     StaticData4:"With",
                    //     GroomGrandFatherName: "Sandeep Rawat",
