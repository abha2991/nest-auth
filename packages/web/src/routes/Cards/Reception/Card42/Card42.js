...
import receptionCard1 from '../../../img/Reception/Reception_3_1.png'
import receptionCard2 from '../../../img/Reception/Reception_3_2.png'
...
const Card42 = () => {
  ...
  const PostData = async (e) => {
    ...
    const res = await fetch(`http://localhost:3001/api/card1/receptioncard1`, {
      method: 'POST',
      credentials: 'include',
      headers: {
