                            ...
                            <div style={{
                              ...
                              textAlign: "center", width: "100%", fontFamily: 'JosefinSans', color: "#ffd167", height: "100%", padding: "100px 0px 100px"
                                ...
                                <div className="editable" {...hover1}>
                                    <h2 data-bs-toggle="modal" data-bs-target="#id1" style={{ fontFamily: "cac-champagne", fontSize: "50px", marginBottom: "0", lineHeight: "normal" }}>{cardData.BrideName}</h2>
                                ...
                                <div className="editable" {...hover2}>
                                    <h2 data-bs-toggle="modal" data-bs-target="#id2" style={{ fontFamily: "cac-champagne", fontSize: "50px", lineHeight: "normal" }}>{cardData.GroomName}</h2>
                                    <FontAwesomeIcon icon={faPenToSquare} style={{ backgroundColor: "#50024B" }} />
                                </div>
                                ...
                                <div style={{ maxWidth: "200px", margin: "auto" }}>
                                    ...
                                    <div className="editable" {...hover3}>
                                        <h4 data-bs-toggle="modal" data-bs-target="#id3" className="mb-0 pt-2">{cardData.Date}</h4>
                                        <FontAwesomeIcon icon={faPenToSquare} style={{ backgroundColor: "#50024B" }} />
                                    </div>
                                    <div className="editable" {...hover4}>
                                        <p data-bs-toggle="modal" data-bs-target="#id4" className="pb-2 mb-0" style={{ fontSize: "10px" }}>{cardData.Time}</p>
                                        <FontAwesomeIcon icon={faPenToSquare} style={{ backgroundColor: "#50024B" }} />
                                    </div>
                                    <hr className="mt-0" />
                                </div>
                                <div className="editable" {...hover5}>
                                    <p data-bs-toggle="modal" data-bs-target="#id5" style={{ fontSize: "10px" }}>{cardData.Address}</p>
                                    <FontAwesomeIcon icon={faPenToSquare} style={{ backgroundColor: "#50024B" }} />
                                </div>
                            </div>
                        </div>
