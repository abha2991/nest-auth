...
import weddingCard1 from '../../../img/Wedding/Wedding_17_1.png'
import weddingCard2 from '../../../img/Wedding/Wedding_17_2.png'
import weddingCard3 from '../../../img/Wedding/Wedding_17_3.png'
import weddingCard4 from '../../../img/Wedding/Wedding_17_4.png'
...
const Card75 = () => {
  ...
  const FirstPageData = ['name1', 'name2', 'Emraan Khan', 'Aaisha Khan']
          ...
          <div className="col-md-4">
            <div className="card-box">
              ...
              >
                ...
                <h5 data-bs-toggle="modal" data-bs-target="#id9" style={{ maxWidth: '300px', margin: 'auto' }}>
                  {thirdPageData.date1}
                </h5>
