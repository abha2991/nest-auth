...
import weddingCard1 from '../../../img/Wedding/Wedding_4_1.png'
import weddingCard2 from '../../../img/Wedding/Wedding_4_2.png'
import weddingCard3 from '../../../img/Wedding/Wedding_4_3.png'
import weddingCard4 from '../../../img/Wedding/Wedding_4_4.png'
        ...
        {weddingFourthPageCardData?.map((val, index) => {
          return (
            <Modal
              ...
              id={`id${index + 24}`}
              onClick={() => {
                let name = textData4[index]
                let value = textData4[index + 5]
