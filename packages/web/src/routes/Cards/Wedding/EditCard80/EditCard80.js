...
import weddingCard1 from '../../../img/Wedding/Wedding_21_1.png'
import weddingCard2 from '../../../img/Wedding/Wedding_21_2.png'
...
const EditCard80 = () => {
  ...
  const PostData = async (e) => {
    ...
    setLoading(true)
    const res = await fetch(`http://localhost:3001/api/card1/weddingcard15`, {
      method: 'POST',
      credentials: 'include',
      headers: {
        'Content-Type': 'application/json'
