  ...
  useEffect(() => {
    if (textdata) {
      setCardData({
        ...
        StaticData3: textdata[0]?.staticdata3 ?? '',
        GroomName: textdata[0]?.groomName ?? '',
        StaticData4: textdata[0]?.staticdata4 ?? '',
        StaticData5: textdata[0]?.staticdata5 ?? '',
        Date: textdata[0]?.date ?? '',
        Time: textdata[0]?.time ?? '',
        Address: textdata[0]?.venue ?? ''
      })
    }
  }, [textdata])
