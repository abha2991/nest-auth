...
function Header() {
  ...
  return (
    <>
      <body className={isActive ? 'skin-blue sidebar-mini ' : 'skin-blue sidebar-mini sidebar-collapse'}>
            ...
            <nav className="navbar blue-bg navbar-static-top">
              ...
              <div className="navbar-custom-menu">
                <ul className="nav navbar-nav">
                  <li
                    className={logtoggle ? 'dropdown user user-menu p-ph-res show' : 'dropdown user user-menu p-ph-res'}
                    onClick={handlelogToggle}
                  >
                    <a href="#" className="dropdown-toggle" data-toggle="dropdown" style={{ textDecoration: 'none' }}>
                      <img src={img1} className="user-image" alt="User Image" />
                      <span className="hidden-xs">Admin</span>
                    </a>
                    <ul className={logtoggle ? 'dropdown-menu show' : 'dropdown-menu'}>
                      {logtoggle && (
                        <li>
                          <a
                            style={{ cursor: 'pointer', border: '1px solid #ddd', textDecoration: 'none' }}
              ...
              <ul className="sidebar-menu tree" data-widget="tree">
                ...
                <li className="dropdown">
                  ...
                  <Link
                    ...
                    className="span-underline dropdown-toggle"
                    id="card-details"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    <i className="fa fa-flag-checkered"></i> <span>Card Category</span>
                    {/*<span className="pull-right-container">*/}
                    {/*  <i className="fa fa-angle-left pull-right"></i>*/}
                    {/*</span>*/}
                  </Link>
                  ...
                  >
                    <a href="/wedding-cards" className="dropdown-item">
                      Wedding Cards
                    </a>
                    <a href="/engagement-cards" className="dropdown-item">
                      Engagement Cards
                    </a>
                    <a href="/birthday-cards" className="dropdown-item">
                      Birthday Cards
                    </a>
                    <a href="/reception-cards" className="dropdown-item">
                      Reception Cards
                    </a>
                    <a href="/congratulations-cards" className="dropdown-item">
                      Congratulations Cards
                    </a>
                    <a href="/anniversary-cards" className="dropdown-item">
                      Anniversary Cards
                    </a>
                    <a href="/baby-shower-cards" className="dropdown-item">
                      Baby Shower Cards
                    </a>
                    <a href="/get-well-soon-cards" className="dropdown-item">
                      Get Well Soon Cards
                    </a>
                    <a href="/thank-you-cards" className="dropdown-item">
                      Thank You Cards
                    </a>
                    <a href="/miss-you-cards" className="dropdown-item">
                      Miss You Cards
                    </a>
                  </div>
                </li>
                <li>
                  {' '}
                  <Link to="/all-drafts" className="span-underline">
                    <i className="fa fa-flag-checkered"></i> <span>Drafts</span>
                    <span className="pull-right-container">
                      <i className="fa fa-angle-left pull-right"></i>
                    </span>
                  </Link>
                ...
                <li>
                  ...
                  <Link to="/enter-card-details" className="span-underline">
                    <i className="fa fa-search"></i> <span>Enter Card Details</span>
                    <span className="pull-right-container">
                      <i className="fa fa-angle-left pull-right"></i>
                    </span>
                  </Link>
                ...
                <li className={toggleState === 9 ? 'active' : null}>
                  <Link to="/customize-cards-query" className="span-underline">
