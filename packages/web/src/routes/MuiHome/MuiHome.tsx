  ...
  return (
    <>
      ...
      <Container sx={{ py: '30px' }}>
        ...
        <Grid container sx={{ backgroundColor: '#C59FAC', borderRadius: '10px' }}>
          <Grid item sm={4} sx={{ pt: '40px' }}>
            <ThemeProvider theme={theme}>
              <Typography variant="h4" sx={{ display: 'flex', justifyContent: 'flex-end' }} color="white">
                Shop Wedding <br />
                Invitation
                <br />
                E-Cards
        ...
        {/*                <Grid container  sx={{backgroundColor:"#C59FAC",borderRadius:"10px"}}>*/}
        {/*  <Grid item sm={4} sx={{pt:"40px"}}>*/} {/*       <ThemeProvider theme={theme}>*/}{' '}
        {/*    <Typography variant="h4" sx={{display:"flex",justifyContent: "flex-end"}} color="white">Shop Wedding <br />*/}{' '}
        {/*                                       Invitation<br/>*/}{' '}
        {/*                                          E-Cards</Typography></ThemeProvider>*/} {/*  </Grid>*/}{' '}
        {/*     <Grid item sm={8} sx={{pt:"40px"}}>*/}{' '}
        {/*    <StyledImage  sx={{maxWidth:"100%"}} src={Banner}></StyledImage>*/} {/*  </Grid>*/}
        ...
        {/*                <KeyboardArrowRight sx={{color:"white"}}/>*/} {/*            )}*/} {/*</Button>*/}{' '}
        {/*      }*/} {/*      backButton={*/}{' '}
        {/*          <Button size="small" onClick={handleBack} disabled={activeStep === 0}>*/}{' '}
        {/*  {theme.direction === 'rtl' ? (*/} {/*      <KeyboardArrowRight sx={{color:"white"}} />*/} {/*  ) : (*/}{' '}
        {/*      <KeyboardArrowLeft sx={{color:"white"}} />*/} {/*  )}*/} {/*              Back*/} {/*</Button>*/}{' '}
        {/*      }*/} {/*  />*/}
      </Container>
      ...
      <Container>
        ...
        >
          ...
          <Link href="#" sx={{ fontWeight: 'bold', textDecoration: 'none', color: '#9505F9' }}>
            See All
          </Link>
        </Box>
        <Grid container textAlign="center" justifyContent="center">
          ...
          {/*            {data?.map(())}*/}
          <Grid item sm={3}>
            <StyledImage sx={{ maxWidth: '100%' }} src={Wedding}></StyledImage>
            <Typography variant="h6">Wedding</Typography>
          </Grid>
          <Grid item sm={3}>
            <StyledImage sx={{ maxWidth: '100%' }} src={Engagement}></StyledImage>
            <Typography variant="h6">Engagement</Typography>
          </Grid>{' '}
          <Grid item sm={3}>
            <StyledImage sx={{ maxWidth: '100%' }} src={Birthday}></StyledImage>
            <Typography variant="h6">Birthday</Typography>
          </Grid>{' '}
          <Grid item sm={3}>
            <StyledImage sx={{ maxWidth: '100%' }} src={SaveTheDate}></StyledImage>
            <Typography variant="h6">Save The Date</Typography>
          </Grid>
        </Grid>
      </Container>
