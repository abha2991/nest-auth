...
import {CardDto} from '../card1/dto/card.dto'
...
//console.log(array[2])
      ...
      const filePath = path.resolve(__dirname,'assets',details[0].video)
        ...
        const newFileName = `${details[0].video.replace(extname(details[0].video), '')}-${Date.now()}${extname(details[0].video)}`
                  ...
                  "actions":{
                      "postrender": [
                          ...
                          },
                          {
                              ...
                              "input": "encoded.mp4",
                              "output": "/Users/abha/Desktop/myresult1.mp4"
                          }
                      ]
                  }
              }
